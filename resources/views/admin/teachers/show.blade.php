    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 font-weight-bold mb-0">
                <i class="bi bi-person-badge-fill me-2 text-primary"></i>{{ __('Teacher Details') }}
            </h2>
            <div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom py-3 d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span class="badge bg-secondary font-monospace">Emp ID: {{ $teacher->employee_id }}</span>
                            </div>
                        </div>
                        <span class="badge bg-info text-dark font-monospace fs-6">{{ $teacher->subject }}</span>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded border">
                                    ...
                                    <div class="fs-6 fw-semibold text-dark">
                                        <i class="bi bi-envelope me-2 text-primary"></i>{{ $teacher->email }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded border">
                                    <small class="text-muted text-uppercase fw-bold d-block mb-1" style="font-size: 0.75rem;">Subject / Department</small>
                                    <div class="fs-6 fw-semibold text-dark">
                                        <i class="bi bi-journal-bookmark me-2 text-primary"></i>{{ $teacher->subject }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded border">
                                    ...
                                    <div class="fs-6 fw-semibold text-dark">
                                        <i class="bi bi-telephone me-2 text-primary"></i>{{ $teacher->phone ?? 'Not Provided' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded border">
                                    ...
                                    <div class="fs-6 fw-semibold text-dark">
                                        <i class="bi bi-clock-history me-2 text-primary"></i>{{ $teacher->created_at ? $teacher->created_at->format('M d, Y H:i A') : 'N/A' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="p-3 bg-light rounded border">
                                    ...
                                    <div class="fs-6 fw-semibold text-dark">
                                        <i class="bi bi-geo-alt me-2 text-primary"></i>{{ $teacher->address ?? 'Not Provided' }}
                                    </div>
                                </div>
                            </div>
                        </div>
