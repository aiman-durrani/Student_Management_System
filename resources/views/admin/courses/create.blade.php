    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 font-weight-bold mb-0">
                <i class="bi bi-journal-plus me-2 text-primary"></i>{{ __('Add New Course') }}
            </h2>
                                    ...
                                    <div class="border rounded p-3 bg-light">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <label class="fw-bold text-dark mb-0">
                                                <i class="bi bi-people-fill me-1 text-primary"></i> Enroll Students (Optional)
                                            </label>
                                            <span class="badge bg-secondary">{{ count($students) }} Total Available</span>
                                        </div>
                                        <small class="text-muted d-block mb-3">Select the students you want to enroll in this course.</small>
